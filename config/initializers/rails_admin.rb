# RailsAdmin config file. Generated on February 04, 2014 19:25
...
RailsAdmin.config do |config|
  ...
  config.main_app_name = ['Shopping Cart', 'Admin']
  ...
  # config.excluded_models = ['Product', 'User']
  ...
  #     configure :product_name, :string 
  #     configure :ccolor, :string 
  #     configure :quantity, :integer 
  #     configure :lens_options, :string 
